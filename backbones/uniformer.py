...
from backbones.Uniformer.defaults import get_cfg

def load_config(args=None, path_to_config=None):
    """
...
class Uniformer(nn.Module):
    ...
    def __init__(self,yaml_path):
        super().__init__()
        path_to_configs = [yaml_path]
        for path_to_config in path_to_configs:
    ...
    def load_weight(self, path):
        ...
        print("Uniformer Loaded!")

from fvcore.nn import  FlopCountAnalysis, flop_count_table
if __name__ == "__main__":
    model = Uniformer()
    print(flop_count_table(FlopCountAnalysis(model,[torch.randn(1,3,16,224,224)])))